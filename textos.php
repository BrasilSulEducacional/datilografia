<div class=main>
    <div class=headerTextos>
        <label id=codigo>Código:<input type="text" id="cod" autocomplete="off"></label>
        <label>Nome:<input type="text" id="nome" autocomplete="off" readonly></label>
    </div>
...
<script>
    $(function() {
        ...
        $('textarea#texto').on('mousedown', function(e) {
            e.preventDefault();
        });
    });
</script>
